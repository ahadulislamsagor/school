            ...
            <div class="bg-blue-700 absolute top-0 right-0 mt-12 -mr-6 shadow rounded-bl rounded-br">
                <div class="hidden h-24 w-48" id="navdropdown">
                    <div class="px-8 py-4 border-t border-blue-800">
                        <a href="<?php echo e(route('profile')); ?>" class="flex items-center pb-3 text-sm text-gray-200 font-semibold">
                        ...
                        <form action="<?php echo e(route('logout')); ?>" method="POST" class="pb-2">
                            <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\xampp\htdocs\laravel-school-management-system\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>
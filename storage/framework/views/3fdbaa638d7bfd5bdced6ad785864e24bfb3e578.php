    ...
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="<?php echo e(route('classes.create')); ?>" class="bg-gray-200 text-gray-700 text-sm uppercase py-2 px-4 flex items-center rounded">
        ...
        <div class="mt-8 bg-white rounded border-b-4 border-gray-300">
            ...
            <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex flex-wrap items-center text-gray-700 border-t-2 border-l-4 border-r-4 border-gray-300">
                    <div class="w-1/12 px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight"><?php echo e($class->class_numeric); ?></div>
                    <div class="w-2/12 px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight"><?php echo e($class->class_name); ?></div>
                    ...
                    <div class="w-4/12 px-4 py-3 text-sm text-gray-600 text-center tracking-tight">
                        <?php $__currentLoopData = $class->subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="bg-gray-200 text-sm mr-1 mb-1 px-2 font-semibold border rounded-full"><?php echo e($subject->subject_code); ?></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <div class="w-2/12 px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight"><?php echo e($class->teacher->user->name ?? ''); ?></div>
                    <div class="w-2/12 flex items-center justify-end px-3">
                        ...
                        <form action="<?php echo e(route('classes.destroy',$class->id)); ?>" method="POST" class="inline-flex ml-1">
                            <?php echo csrf_field(); ?>
                        ...
                        <a href="<?php echo e(route('class.assign.subject',$class->id)); ?>" class="ml-1 bg-gray-600 block p-1 border border-gray-600 rounded-sm" title="assign subject">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\school\resources\views/backend/classes/index.blade.php ENDPATH**/ ?>
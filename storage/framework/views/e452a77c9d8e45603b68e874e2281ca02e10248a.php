...
<div class="home">
    ...
    <?php if(auth()->check() && auth()->user()->hasRole('Parent')): ?>
        <?php echo $__env->make('dashboard.parents', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\school\resources\views/home.blade.php ENDPATH**/ ?>
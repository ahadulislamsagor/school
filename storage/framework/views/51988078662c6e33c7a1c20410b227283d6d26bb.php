        ...
        <div class="mt-2">
            <form action="" method="POST" class="remove-record text-center">
                ...
                <div class="md:flex md:items-center mb-6">
                    <h3 class="text-xl text-white font-bold">Are you sure you want to delete <?php echo e($name ?? ''); ?>?</h3>
                </div>
...
</div><?php /**PATH C:\xampp\htdocs\school\resources\views/backend/modals/delete.blade.php ENDPATH**/ ?>
    ...
    <div class="roles">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                ...
                <a href="<?php echo e(route('role.create')); ?>" class="bg-gray-200 text-gray-700 text-sm uppercase py-2 px-4 mr-2 flex items-center rounded">
        ...
        <div class="table w-full mt-8 bg-white rounded">
            <form action="<?php echo e(route('role.update',$role->id)); ?>" method="POST" class="w-full max-w-lg px-6 py-12">
                <?php echo csrf_field(); ?>
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                        <input name="name" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" id="inline-full-name" type="text" value="<?php echo e($role->name); ?>">
                                ...
                                <label>
                                    <input name="selectedpermissions[]" class="mr-2 leading-tight" type="checkbox" value="<?php echo e($permission->name); ?>"
                                        <?php $__currentLoopData = $role->permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php echo e(($item->id === $permission->id) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\school\resources\views/backend/roles/edit.blade.php ENDPATH**/ ?>